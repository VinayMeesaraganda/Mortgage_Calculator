    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="space-y-6 text-slate-700">
        <section>
          ...
          <p>
            Welcome to our Mortgage Calculator. We respect your privacy and are committed to protecting any information you share with us.
        ...
        <section>
          ...
          <p className="mb-3">
            We collect anonymous usage data through Google Analytics to understand how visitors use our calculator. This includes:
          </p>
          ...
          <p className="mt-3">
            <strong>Important:</strong> We do NOT collect or store any financial information you enter into the calculator. 
            All calculations are performed locally in your browser, and your data never leaves your device.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Since we don't collect or store your financial data, there is minimal security risk. All calculations
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Use the calculator anonymously</li>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-800 mb-3">Changes to This Policy</h2>
          <p>
        ...
        <section>
          ...
          <p>
            If you have questions about this privacy policy, please contact us through GitHub issues or email.
          </p>
        </section>
      </div>
    </div>
