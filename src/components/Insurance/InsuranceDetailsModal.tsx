            ...
            {insurance.category === 'life' && (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {insurance.beneficiaries?.map(b => b.name).join(', ') || 'Not specified'}
                  </p>
                </div>
              </div>
            )}
            {insurance.category === 'auto' && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold">
                    {insurance.vehicleDetails
                      ? `${insurance.vehicleDetails.make} ${insurance.vehicleDetails.model} (${insurance.vehicleDetails.registrationNumber})`
                      : 'Not specified'}
                  </p>
                </div>
                <div>
